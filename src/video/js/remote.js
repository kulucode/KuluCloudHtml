...
function carlist(){
  ...
  doRefresh(null, "KULUINTERFACE", "searchTruckWordParasList", "", function(data) {
    ...
    if (data.code == 0) {
      ...
      if (Cardata.truckorg == "某某项目公司01-项目组02") {
        $(".team_contents1").append("<p>" + Cardata.paltenum + "</p>");
      }
      else if (Cardata.truckorg == "酷陆科技-测试组") {
        $(".team_contents2").append("<p>" + Cardata.paltenum + "</p>");
      }else {
        $(".team_contents3").append("<p>" + Cardata.paltenum + "</p>");
      }
      });
    } else {
      alert(data.msg);
