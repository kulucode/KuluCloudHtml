window.jwplayer = function (e) {
    ...
    var i, o;
    i = [], o = function () {
        var e = {}, t = Array.prototype, n = Object.prototype, i = Function.prototype, o = t.slice, r = t.concat, a = n.toString, s = n.hasOwnProperty, l = t.map, c = t.reduce, u = t.forEach, d = t.filter, p = t.every, f = t.some, h = t.indexOf, g = Array.isArray, w = Object.keys, m = i.bind, v = function (e) {
    ...
    i = [n(9), n(1), n(34), n(35), n(23), n(36), n(13), n(61), n(38), n(64), n(150), n(149), n(65)], o = function (e, t, n, i, o, r, a, s, l, c, u, d, p) {
        ...
        }, f.indexOf = t.indexOf, f.noop = function () {
        }, f.seconds = e.seconds, f.prefix = e.prefix, f.suffix = e.suffix, t.extend(f, r, a, l, n, s, i, o, c, u, d, p), f
    }.apply(t, i), !(void 0 !== o && (e.exports = o))
}, function (e, t, n) {
    var i, o;
    i = [n(1)], o = function (e) {
    ...
    i = [n(3), n(4), n(1), n(2)], o = function (e, t, n, i) {
        ...
        var l = t.touchEvents, c = "PointerEvent"in window, u = "ontouchstart"in window, d = !(c || u && i.isMobile()), p = i.isFF() && i.isOSX(), f = function (e, t) {
            function i(e) {
            ...
            function w(e) {
                var n = 6;
                if (x)v(l.DRAG, e); else {
                    var i = o(e, "X"), r = o(e, "Y"), a = i - E, c = r - k;
            ...
            var j, y, b = e, x = !1, E = 0, k = 0, C = 0, A = 300;
    ...
    i = [n(1)], o = function (e) {
        ...
        var n = function (e) {
            ...
            if ("s" === t.slice(-1))r = parseFloat(t); else if ("m" === t.slice(-1))r = 60 * parseFloat(t); else if ("h" === t.slice(-1))r = 3600 * parseFloat(t); else if (o > 1) {
                var a = o - 1;
                    ...
                    if (d > 0) {
                        ...
                        if ("PRIV" === o.value.key) {
                            if ("com.apple.streaming.transportStreamTimestamp" === f) {
                                var h = 1 & t.syncSafeInt(a.subarray(c, c += 4)), g = t.syncSafeInt(a.subarray(c, c += 4));
    ...
    function n(e, t) {
        ...
        try {
            o && (this.lineNumber = r, Object.defineProperty ? Object.defineProperty(this, "column", {value: a}) : this.column = a)
        } catch (c) {
        }
    }
    ...
    i = [n(1), n(2), n(20), n(31), n(133), n(32)], o = function (e, t, i, o, r, a) {
        function s(e, t, n, a) {
            ...
            try {
                if (u && "tt" === i.localName(u))s = r(e.responseXML), c = this.convertToVTTCues(s), delete t.xhr, n(c); else {
    ...
    i = [n(9), n(173)], o = function (e, t) {
        ...
        return {css: o, style: r, clearCss: t.clear, transform: a, hexToRgba: s}
    }.apply(t, i), !(void 0 !== o && (e.exports = o))
}, , function (e, t, n) {
    var i, o;
    i = [n(9)], o = function (e) {
    ...
    i = [n(1), n(15)], o = function (e, t) {
        ...
        }, {configName: "playready", keyName: "com.microsoft.playready"}], o = [], r = {}, a = function (t) {
    ...
    i = [n(2), n(42), n(129), n(1), n(3), n(148), n(4), n(5)], o = function (e, t, n, i, o, r, a, s) {
        var l = function () {
            function r(e, t) {
                var n = i.extend({}, t, {type: e}), o = this.mediaModel;
                switch (e) {
                    case"flashThrottle":
            ...
            var u, d, p = this, f = !1, h = !0, g = e.noop;
            this.mediaController = i.extend({}, o), this.mediaModel = new c, n.model(this), this.set("mediaModel", this.mediaModel), this.setup = function (e) {
                ...
                t || (t = this.get("playlist")[this.get("item")]), this.set("position", t.starttime || 0), this.set("duration", t.duration && e.seconds(t.duration) || 0), this.mediaModel.set("playAttempt", !0), this.mediaController.trigger(a.JWPLAYER_MEDIA_PLAY_ATTEMPT, {playReason: this.get("playReason")}), d.load(t)
                ...
                var t = !this.get("advertising") || this.get("advertising").autoplayadsmuted, n = l() && (e.isSafari() || e.isChrome() || e.isFacebook()), i = e.isAndroid() && e.isChrome(), o = n || i, r = 1 === this.get("sdkplatform"), a = !this.get("sdkplatform") && t && o || r;
    ...
    i = function () {
        ...
        function n(n, o, r) {
            var a = this;
            a.hasBeenReset = !1;
            var s = "", l = !1, c = n, u = o, d = r, p = null, f = "", h = !0, g = "auto", w = "start", m = 50, v = "middle", j = 50, y = "middle";
        ...
        var i = "auto", o = {"": !0, lr: !0, rl: !0}, r = {start: !0, middle: !0, end: !0, left: !0, right: !0};
    ...
    i = [n(9), n(1), n(146)], o = function (e, t, n) {
        ...
        return i.classList = function (e) {
            ...
            var n = e.getBoundingClientRect(), i = window.pageYOffset, o = window.pageXOffset;
    ...
    i = [n(1), n(38)], o = function (e, t) {
        ...
        return o.getAbsolutePath = function (e, i) {
            if (t.exists(i) || (i = document.location.href), t.exists(e)) {
                if (n(e))return e;
                var o, r = i.substring(0, i.indexOf("://") + 3), a = i.substring(r.length, i.indexOf("/", r.length + 1));
            ...
            var i = t < 0 ? "-" : "";
            t = Math.abs(t);
            var o = Math.floor(t / 3600), r = Math.floor((t - 3600 * o) / 60), a = Math.floor(t % 60);
    ...
    i = [n(34), n(15), n(1), n(141), n(27)], o = function (e, t, n, i, o) {
        ...
        var c = n.find(i, n.matches({name: "html5"})), u = c.supports;
        return c.supports = function (e, n) {
            ...
            name: "hlsjs", supports: function (n, i) {
                var o = e.isChrome() || e.isFF() || e.isIE(11) && n.hlsjsdefault, a = e.isAndroid() && n.hlsjsdefault;
    ...
    i = [n(142), n(1), n(41)], o = function (e, t) {
        function i(e, n, i) {
            var o = t.indexOf(e, t.findWhere(e, {name: i})), r = t.indexOf(e, t.findWhere(e, {name: n}));
            if (!(r < o)) {
        ...
        var o, r = e.registerProvider, a = e.prototype.reorderProviders;
    ...
    var r = n(10), a = n(16), s = i(a), l = n(87), c = n(85), u = n(95), d = i(u), p = "4.0.5";
    t.VERSION = p;
    var f = 7;
    ...
    i = [n(33), n(53), n(1), n(42)], o = function (e, t, n, i) {
        function o(e, t) {
            for (var n = 0; n < e.length; n++) {
                ...
                if (o)return {type: i.type, provider: o.providerToCheck}
            }
            return null
        }
        ...
        a.filterPlaylist = function (e, t) {
            var i = [], o = t.getProviders(), r = t.get("preload"), a = t.get("feedid");
        ...
        var s = function (e, i) {
            var o = e.sources, a = i.get("androidhls"), s = e.drm || i.get("drm"), l = e.preload || i.get("preload"), c = r(e.withCredentials, i.get("withCredentials")), u = i.get("hlsjsdefault");
    ...
    i = [n(2), n(25), n(4), n(3), n(14), n(1)], o = function (e, t, n, i, o, r) {
        var a = {FLASH: 0, JAVASCRIPT: 1, HYBRID: 2}, s = function (s) {
            ...
            function u() {
                w = o.loaderstatus.ERROR, g.trigger(n.ERROR, {url: s})
            }

            var d, p, f, h, g = r.extend(this, i), w = o.loaderstatus.NEW;
            this.load = function () {
    ...
    i = [n(1), n(36)], o = function (e, t) {
        ...
        var l = function () {
            ...
            if ("XDomainRequest"in window && u(t))p = f.xhr = new window.XDomainRequest, p.onload = r(f), p.ontimeout = p.onprogress = l, c = !0; else {
    ...
    i = [n(2), n(3), n(1)], o = function (e, t, n) {
        ...
        function r(r, a, c, u) {
            ...
            return o(d, "on", t.on), o(d, "once", t.once), o(d, "_eventQueue", []), o(d, "off", function () {
                ...
                var i = d._eventQueue;
                i.push({type: e, json: n}), w > -1 || (w = setTimeout(function () {
                    var e = i.length;
                    for (w = -1; e--;) {
                        var n = i.shift();
                        if (n.json) {
                ...
                var r = Array.prototype.slice.call(arguments, 1), a = e.tryCatch(function () {
                    if (r.length) {
    ...
    i = [n(1)], o = function (e) {
        ...
        function a(t) {
            return !!e.isArray(t) && e.some(t, function (e) {
                    var t = e.height || e.bandwidth, n = this[t];
                    return this[t] = 1, n
                }, {})
        }
    ...
    i = [n(144), n(1)], o = function (e, t) {
        var n = function () {
            var n = {}, i = {}, o = {}, r = {}, a = (new Date).getTime();
            return a < 1 && (a = 1), {
                start: function (t) {
                    ...
                    for (var l in n)if (Object.prototype.hasOwnProperty.call(n, l)) {
                        var c = a + e.now(), u = c - n[l];
                        s[l] = s[l] + u || u
                    }
                    return {counts: t.extend({}, o), sums: s, events: t.extend({}, r)}
                }, tick: function (t) {
                    r[t] = a + e.now()
    ...
    i = [n(121), n(21), n(1)], o = function (e, t, n) {
        ...
        return n.extend(e, {selectPlayer: o})
    }.apply(t, i), !(void 0 !== o && (e.exports = o))
}, , , , function (e, t, n) {
    var i, o;
    ...
    t.__esModule = !0;
    var a = n(47), s = o(a), l = n(98), c = i(l), u = n(16), d = i(u), p = n(10), f = o(p), h = n(97), g = o(h), w = n(96), m = i(w), v = r();
    ...
    var r = n(88), a = i(r), s = n(89), l = i(s), c = n(90), u = i(c), d = n(91), p = i(d), f = n(92), h = i(f), g = n(93), w = i(g), m = n(94), v = i(m)
}, function (e, t, n) {
    "use strict";
    t.__esModule = !0;
    var i = n(10);
    ...
    var f = n(10), h = o(f), g = n(16), w = i(g), m = n(47)
}, function (e, t) {
    "use strict";
    function n(e) {
        this.string = e
    ...
    e.exports = (i["default"] || i).template({
        compiler: [7, ">= 4.0.0"], main: function (e, t, n, i, o) {
            var r = e.lambda, a = e.escapeExpression;
    ...
    var i = n(100);
    "string" == typeof i && (i = [["all-players", i, ""]]), n(114).style(i, "all-players"), i.locals && (e.exports = i.locals)
}, function (e, t, n) {
    var i, o;
    ...
    i = [n(4), n(5), n(3), n(2), n(66), n(1), n(178), n(116), n(117), n(119), n(26)], o = function (e, t, n, i, o, r, a, s, l, c, u) {
        var d = function (d, p) {
            ...
            return this.getPlugin = function (e) {
                ...
                var e = f.getItemQoe(), t = w.between("setup", "ready"), n = e.getFirstFrame();
                return {setupTime: t, firstFrame: n, player: w.dump(), item: e.dump()}
                ...
                if (r.isObject(e) && e.reason && (n = e), n || (n = {reason: "external"}), e === !0)return f.play(n), h;
    ...
    i = [n(179), n(3), n(1), n(4)], o = function (e, t, n, i) {
        var o = function (t, o, r, a) {
            ...
            function p(e, t) {
                clearTimeout(f), h.trigger(i.JWPLAYER_SETUP_ERROR, {message: e + ": " + t}), h.destroy()
            }

            var f, h = this, g = e.getQueue(), w = 30;
            this.start = function () {
    ...
    i = [n(2), n(19), n(18)], o = function (e, t, n) {
        var i = function (i, o) {
            ...
            function f() {
                for (var e = [{id: "off", label: "Off"}], t = 0; t < w.length; t++)e.push({
                    id: w[t]._id,
    ...
    i = [n(120), n(126), n(1), n(122), n(123), n(29), n(131), n(52), n(51), n(2), n(76), n(3), n(30), n(5), n(4), n(163), n(125)], o = function (e, t, n, i, o, r, a, s, l, c, u, d, p, f, h, g, w) {
        ...
        return j.prototype = {
            ...
            setup: function (r, g) {
                ...
                function y() {
                    je.trigger(h.JWPLAYER_READY, {setupTime: 0}), je.triggerAfterReady = je.trigger;
                ...
                function b(e) {
                    e && window.IntersectionObserver && (x(), ge = new window.IntersectionObserver(E, {threshold: [0, .25, .5, .75, 1]}), ge.observe(e))
                }
                ...
                function C(e) {
                    var t = document.documentElement, n = document.body, i = {
                        top: 0,
                        left: 0,
                    ...
                    var u = o.width * o.height, d = r.width * r.height;
                    return u ? d / u : 0
                }

                function A(e, t) {
                    var n = Math.max(e.top, t.top), i = Math.min(e.bottom, t.bottom), o = Math.max(e.left, t.left), r = Math.min(e.right, t.right), a = r - o, s = i - n;
                    return a >= 0 && s >= 0 && {top: n, bottom: i, left: o, right: r, width: a, height: s}
                }
                ...
                function R(e) {
                    var t = we.getProviders(), n = t.required(e, we.get("primary"));
                ...
                function M() {
                    for (; je.eventsQueue.length > 0;) {
                        var e = je.eventsQueue.shift(), t = e[0], n = e[1] || [];
                        je["_" + t].apply(je, n)
                    }
                }
                ...
                function N(e) {
                    if (e && we.set("playReason", e.reason), we.get("state") !== f.ERROR) {
                        ...
                        if (we.get("state") === f.COMPLETE && (W(!0), z(0)), !me && (me = !0, je.triggerAfterReady(h.JWPLAYER_MEDIA_BEFOREPLAY, {playReason: we.get("playReason")}), me = !1, he))return he = !1, void(fe = null);
                        var i;
                        if (J()) {
                ...
                function U(e) {
                    var t = s(e);
                    return t = s.filterPlaylist(t, we), we.set("playlist", t), n.isArray(t) && 0 !== t.length ? (R(t), !0) : (je.triggerError({message: "Error loading playlist: No playable sources found"}), !1)
                }
                ...
                function H(e) {
                    V(we.get("item") - 1, e || {reason: "external"})
                }
                ...
                function q() {
                    if (J()) {
                        ...
                        fe = q;
                        var e = we.get("item");
                        return e === we.get("playlist").length - 1 ? void(we.get("repeat") ? G({reason: "repeat"}) : (we.set("playOnViewable", !1), we.set("state", f.COMPLETE), je.trigger(h.JWPLAYER_PLAYLIST_COMPLETE, {}))) : void G({reason: "playlist"})
                    }
                }
                ...
                var ue, de, pe, fe, he, ge, we = this._model, me = !1, ve = !1, je = this, ye = function () {
                    return we.getVideo()
                }, be = new a;
                be.track(we);
                var xe = new e(r, be), Ee = [];
                we.setup(xe, be), ue = this._view = new u(g, we), pe = new i(g, we, ue, U), pe.on(h.JWPLAYER_READY, j, this), pe.on(h.JWPLAYER_SETUP_ERROR, this.setupError, this), we.mediaController.on("all", m, this), we.mediaController.on(h.JWPLAYER_MEDIA_COMPLETE, function () {
                    ...
                    je.trigger(h.JWPLAYER_FULLSCREEN, {fullscreen: t}), t && we.set("playOnViewable", !1)
                    ...
                    t.length && je.triggerAfterReady(h.JWPLAYER_PLAYLIST_LOADED, {playlist: t})
                }), we.on("change:volume", function (e, t) {
                    je.trigger(h.JWPLAYER_MEDIA_VOLUME, {volume: t})
                }), we.on("change:mute", function (e, t) {
                    je.trigger(h.JWPLAYER_MEDIA_MUTE, {mute: t})
                }), we.on("change:controls", function (e, t) {
                    je.trigger(h.JWPLAYER_CONTROLS, {controls: t})
                }), we.on("change:scrubbing", function (e, t) {
                    t ? F() : N({reason: "interaction"})
                }), we.on("change:captionsList", function (e, t) {
                    try {
                        je.triggerAfterReady(h.JWPLAYER_CAPTIONS_LIST, {tracks: t, track: oe()})
                    } catch (n) {
                    ...
                    var a = {
                        ...
                        id: o,
                        btnClass: r
                    }, s = !1, l = n.map(we.get("dock"), function (e) {
                        var t = e !== a && e.id === a.id;
                        return t ? (s = !0, a) : e
                    });
                    ...
                    var t = we.get("dock") || [];
                    t = n.reject(t, n.matches({id: e})), we.set("dock", t)
            ...
            setupError: function (e) {
                ...
                var a = this;
                n.defer(function () {
                    a.trigger(h.JWPLAYER_SETUP_ERROR, {message: t})
                })
            }
        }, j
    }.apply(t, i), !(void 0 !== o && (e.exports = o))
        ...
        return function (n, i, o) {
            ...
            switch (i) {
                ...
                case"ready":
                    ...
                    e.isUndefined(a) || (r = e.extend({}, o, {viewable: a}))
            }
            return r
        }
    }.apply(t, i), !(void 0 !== o && (e.exports = o))
    ...
    i = [n(128), n(127), n(4), n(5), n(2), n(3), n(1)], o = function (e, t, n, i, o, r, a) {
        ...
        var l = {skipoffset: null, tag: null}, c = function (e, r, c) {
            function u() {
            ...
            var h, g, w, m, v, j = s(r), y = new j(e, r), b = 0, x = {}, E = this, k = a.bind(function (e) {
            ...
            this.loadItem = function (e, i) {
                ...
                var c = r.getProviders(), u = j === t ? "flash" : void 0, d = c.required(s, u);
            ...
            function l(t) {
                ...
                if (f !== o) {
                    ...
                    o.off(), o.on("all", function (t, n) {
                        r && t === i.JWPLAYER_MEDIA_COMPLETE || this.trigger(t, e.extend({}, n, {type: t}))
    ...
    i = [n(66), n(1)], o = function (e, t) {
        ...
        var r = "playlistItem", a = "playAttempt", s = "providerFirstFrame", l = "firstFrame", c = "time", u = "tabHidden", d = "tabVisible", p = "visibilitychange", f = function (e) {
            var t = 0;
            return function (n) {
                var i = n.position;
                i > t && e(), t = i
    ...
    i = [n(21), n(51), n(14), n(62), n(22), n(1), n(2), n(4)], o = function (e, t, i, o, r, a, s, l) {
        function c() {
            var e = {
                ...
                LOAD_PLUGINS: {method: h, depends: ["LOAD_PROMISE_POLYFILL"]},
                LOAD_XO_POLYFILL: {method: f, depends: []},
                LOAD_SKIN: {method: E, depends: []},
                LOAD_PLAYLIST: {method: m, depends: []},
                SETUP_VIEW: {method: k, depends: ["LOAD_SKIN", "LOAD_XO_POLYFILL"]},
                INIT_PLUGINS: {method: g, depends: ["LOAD_PLUGINS", "SETUP_VIEW"]},
                CHECK_FLASH: {method: v, depends: ["SETUP_VIEW"]},
                FILTER_PLAYLIST: {method: j, depends: ["LOAD_PLAYLIST", "CHECK_FLASH"]},
                SET_ITEM: {method: C, depends: ["INIT_PLUGINS", "FILTER_PLAYLIST"]},
                DEFERRED: {method: u, depends: []},
                SEND_READY: {method: A, depends: ["SET_ITEM", "DEFERRED"]}
            };
            return e
        }
        ...
        function v(e, t, n, i) {
            var r = "flash" === t.get("primary"), a = s.flashVersion();
            if (r && a) {
                var l, c = function () {
                ...
                }, d = i.element(), p = d.querySelector(".jw-media");
                d.parentElement || u();
                var f = "" + t.get("id") + "-" + Math.random().toString(16).substr(2), h = t.get("flashloader");
        ...
        function E(e, t) {
            var n = t.get("skin"), o = t.get("skinUrl");
    ...
    i = [n(1), n(2)], o = function (e, t) {
        ...
        return e.extend(a.prototype, {getAllItems: i, track: s, clear: r}), a
    }.apply(t, i), !(void 0 !== o && (e.exports = o))
}, function (e, t, n) {
    var i, o;
    ...
    i = [n(9)], o = function (e) {
        ...
        return function (o) {
            t(o);
            var r = [], a = o.getElementsByTagName("p"), s = 30, l = o.getElementsByTagName("tt");
            if (l && l[0]) {
            ...
            for (var u = 0; u < a.length; u++) {
                ...
                var g = d.innerHTML || d.textContent || d.text || "", w = e.trim(g).replace(/>\s+</g, "><").replace(/(<\/?)tts?:/g, "$1").replace(/<br.*?\/>/g, "\r\n");
                if (w) {
                    var m = d.getAttribute("begin"), v = d.getAttribute("dur"), j = d.getAttribute("end"), y = {
                        begin: i(m, s),
                        text: w
                    };
    ...
    i = [n(25), n(2), n(4), n(3), n(1), n(14)], o = function (e, t, n, i, o, r) {
        ...
        var l = function (l, c) {
            ...
            var f, h = o.extend(this, i), g = r.loaderstatus.NEW, w = !1, m = o.size(c), v = !1;
            this.setupPlugins = function (n, i) {
                var r = [], c = l.getPlugins(), u = i.get("plugins");
                o.each(u, function (i, l) {
                    var d = e.getPluginName(l), p = c[d], f = p.getFlashPath(), h = p.getJS(), g = p.getURL();
                    if (f) {
                        var w = o.extend({name: d, swf: f, pluginmode: p.getPluginmode()}, i);
                        r.push(w)
                    }
                    var m = t.tryCatch(function () {
                        if (h) {
                            ...
                            var r = o.extend({}, e), l = p.getNewInstance(n, r, i);
    ...
    i = [n(11), n(41), n(140), n(1), n(145)], o = function (e, t, i, o, r) {
        ...
        return o.extend(a.prototype, {
            load: function (e) {
                ...
                var n = o.clone(t);
                if ("flash" === e) {
                    var i = o.indexOf(n, o.findWhere(n, {name: "flash"})), r = n.splice(i, 1)[0], a = o.indexOf(n, o.findWhere(n, {name: "html5"}));
                    n.splice(a, 0, r)
                }
                return n
            }, providerSupports: function (e, t) {
                ...
                return e = e.slice(), o.compact(o.map(i, function (t) {
                    for (var i = !1, o = e.length; o--;) {
                        var r = e[o], a = n.providerSupports(t, r.sources[0]);
                ...
                for (var t = this.providers.length, n = 0; n < t; n++) {
                    ...
                    if (this.providerSupports(r, e)) {
                        var a = t - n - 1;
                        return {priority: a, name: r.name, type: e.type, providerToCheck: r, provider: i[r.name]}
                    }
                }
                return null
            }
    ...
    var i, o;
    i = [], o = function () {
        var e = window.performance, t = !(!e || !e.now), n = 1e3, i = function () {
            return t ? e.now() : (new Date).getTime()
        }, o = function () {
            var e = i(), t = e, o = function () {
                var e = i() - t;
                e > n ? e = n : e < 0 && (e = 0), t += e
            };
    ...
    i = [n(1)], o = function (e) {
        ...
        return t.isDvr = function (e, t) {
            ...
            var o = e.isUndefined(i) ? 120 : i, r = "VOD";
    ...
    i = [n(2), n(23), n(5), n(1)], o = function (e, t, i, o) {
        ...
        return r = function (r) {
            ...
            function p(n, i) {
                e.isSafari() && t.css("#" + n + " .jw-video::-webkit-media-text-track-display-backdrop", {backgroundColor: i.backgroundColor}, n, !0), t.css("#" + n + " .jw-video::-webkit-media-text-track-display", A, n, !0), t.css("#" + n + " .jw-video::cue", i, n, !0)
            }
            ...
            function h(e, n) {
                var i = n.color, o = n.fontOpacity;
                if ((i || o !== s.fontOpacity) && (e.color = t.hexToRgba(i || "#ffffff", o)), n.back) {
                    var r = n.backgroundColor, a = n.backgroundOpacity;
            ...
            b = document.createElement("div"), b.className = "jw-captions jw-reset", this.show = function () {
                ...
                var i = _.windowColor, c = _.windowOpacity, d = _.edgeStyle;
                A = {};
                var p = {};
    ...
    i = [n(1), n(2), n(22), n(7), n(39), n(40), n(154), n(157)], o = function (e, t, n, i, o, r, a, s) {
        ...
        var c = r.extend({
            ...
            constructor: function (t, n) {
                ...
                var i = this._model.get("duration"), o = this._model.get("streamType");
                if ("DVR" === o) {
                    var r = (1 - t / 100) * i, a = this._model.get("position"), s = Math.min(r, Math.max(n.dvrSeekLimit, a)), l = 100 * s / i;
                    return 100 - l
                }
                return t
            }, update: function (e) {
                ...
                var e, t = this.seekTo, n = this._model.get("duration"), i = this._model.get("streamType");
                ...
                if (0 !== r) {
                    var a = this._model.get("containerWidth"), s = t.bounds(this.elementRail), l = o.pageX ? o.pageX - s.left : o.x;
                    l = t.between(l, 0, s.width);
                    var c = l / s.width, u = r * c;
                    r < 0 && (u = r - u);
                    var d;
                    if ("touch" === i.getPointerType(o.sourceEvent) && (this.activeCue = e.reduce(this.cues, function (e, t) {
                        ...
                        }.bind(this), void 0)), this.activeCue)d = this.activeCue.text; else {
                        var p = !0;
                    ...
                    var h = f.getWidth(), g = s.width / 100, w = a - s.width, m = 0;
                    h > w && (m = (h - w) / (200 * g));
    ...
    i = [n(2), n(1), n(3), n(22), n(7), n(39), n(158), n(155), n(159), n(68)], o = function (e, t, n, i, o, r, a, s, l, c) {
        ...
        function p(t, n) {
            ...
            var i = document.createElement("button", "google-cast-button"), o = document.createElement("div"), r = n.cast;
        ...
        return t.extend(g.prototype, n, {
            setup: function () {
                ...
                var n, i, s, g = new a(this._model, this._api), w = this._localization.play, m = this._localization.next, v = this._localization.volume, j = this._localization.rewind;
                ...
                this.elements.cc.setup(t, n, {isToggle: !0})
                ...
                var e = this._model.get("position"), t = this._model.get("duration"), n = e - 10, i = 0;
    ...
    i = [n(105), n(2), n(1), n(7)], o = function (e, t, n, i) {
        ...
        return n.extend(o.prototype, {
            setup: function () {
                ...
                var t = this.getDockButton(e), i = t.getAttribute("button"), o = this.model.get("dock"), r = n.findWhere(o, {id: i});
    ...
    i = [n(7), n(2), n(4), n(1), n(3), n(107)], o = function (e, t, n, i, o, r) {
        var a = t.style, s = {linktarget: "_blank", margin: 8, hide: !1, position: "top-right"};
        return function (l) {
            function c() {
                var e = l.get("dock"), n = !(!e || !e.length || "top-right" !== d.position);
                t.toggleClass(u, "below", n)
            }

            var u, d, p = new Image, f = i.extend({}, l.get("logo"));
    ...
    i = [n(1), n(2)], o = function (e, t) {
        ...
        return e.extend(o.prototype, {
            setup: function (e) {
                ...
                var o = "";
                e.isString(n) && (o = 'url("' + n + '")', i = this.image = new Image, i.src = n), t.style(this.el, {backgroundImage: o})
                ...
                if ("uniform" === i) {
                    ...
                    t.style(this.el, {backgroundSize: r})
                }
            }, element: function () {
                return this.el
            }
    ...
    i = [n(2), n(3), n(7), n(28), n(1)], o = function (e, t, n, i, o) {
        var r = function (t, o) {
            this.el = e.createElement(i({
                ...
                var e = t.get("position"), n = t.get("duration"), i = e - 10, r = 0;
    ...
    i = [n(2), n(111), n(1), n(7), n(26)], o = function (e, t, n, i, o) {
        ...
        return n.extend(r.prototype, {
            buildArray: function () {
                ...
                if (r && a) {
                    var s = a.split(".");
                    i.items.push({title: "build: (" + s[0] + "." + s[1] + ")", link: "#"})
                }
                var l = this.model.get("provider");
                if (l && l.name.indexOf("flash") >= 0) {
                    var c = "Flash Version " + e.flashVersion();
                    i.items.push({title: c, link: "http://www.adobe.com/software/flash/about/"})
                }
                return i
            }, buildMenu: function () {
    ...
    i = [n(1), n(2)], o = function (e, t) {
        ...
        return e.extend(n.prototype, {
            hide: function () {
                ...
                var n = {paddingLeft: 0, paddingRight: 0}, i = e.get("controls"), o = e.get("dock"), r = e.get("logo");
                if (r) {
    ...
    i = [n(2), n(4), n(3), n(22), n(143), n(5), n(152), n(153), n(168), n(166), n(165), n(162), n(164), n(160), n(167), n(185), n(170), n(156), n(1), n(110), n(151), n(68), n(161)], o = function (e, t, i, o, r, a, s, l, c, u, d, p, f, h, g, w, m, v, j, y, b, x, E) {
        var k = e.style, C = e.bounds, A = e.isMobile(), _ = ["fullscreenchange", "webkitfullscreenchange", "mozfullscreenchange", "MSFullscreenChange"];
        return function (L, T) {
            function P() {
                return {reason: "interaction"}
            }
            ...
            function R(t) {
                var n = 0, i = T.get("duration"), r = T.get("position");
            ...
            function S(e) {
                ...
                switch (Pe || de(), e.keyCode) {
                    ...
                    case 40:
                        ...
                        break;
                    case 67:
                        var t = L.getCaptionsList(), n = t.length;
                        if (n) {
                    ...
                    default:
                        if (e.keyCode >= 48 && e.keyCode <= 59) {
                            var o = e.keyCode - 48, r = o / 10 * T.get("duration");
                            L.seek(r, P())
                        }
                }
            ...
            function W() {
                var e = document.body.contains(Ce), t = C(Ce), n = Math.round(t.width), i = Math.round(t.height);
                ...
                var o = b(Ce, n, i), r = T.get("controls");
                te(T.get("height")), J(o, T.get("audioMode"), r), st(T, r), oe(n, i), Fe.resize(), F(n, i)
            }

            function F(e, n) {
                Le = e, Te = n, ot.trigger(t.JWPLAYER_RESIZE, {width: e, height: n})
            }

            function J(t, n, i) {
                var o = t < 2, r = T.get("timeSliderAbove"), a = !n && i && r !== !1 && (r || o);
            ...
            function V(t, n, i) {
                ...
                if (n) {
                    var r = {color: n, borderColor: n, stroke: n};
            ...
            function Z() {
                ...
                n.addEventListener("mousemove", ue), Ie = new l(T, _e, {useHover: !0}), Ie.on("click", function () {
                    X({type: t.JWPLAYER_DISPLAY_CLICK}), T.get("controls") && L.play(P())
                }), Ie.on("tap", function () {
                    X({type: t.JWPLAYER_DISPLAY_CLICK}), H()
            ...
            function re() {
                var t = !T.get("autostartFailed"), n = T.get("mute");
            ...
            function se(e) {
                var t = T.get("fullscreen"), n = void 0 !== e.jwstate ? e.jwstate : ae();
                t !== n && T.set("fullscreen", n), B(), clearTimeout(Qe), Qe = setTimeout(oe, 200)
            }

            function le(t, n) {
                n ? (e.addClass(t, "jw-flag-fullscreen"), k(document.body, {"overflow-y": "hidden"}), de()) : (e.removeClass(t, "jw-flag-fullscreen"), k(document.body, {"overflow-y": ""})), oe(), B()
            }
            ...
            function ge(t, n) {
                var i = "audio" === n, o = T.getVideo(), r = o && 0 === o.getName().name.indexOf("flash");
                e.toggleClass(Ce, "jw-flag-media-audio", i), i && !r ? Ce.insertBefore(Me.el, _e) : Ce.insertBefore(Me.el, Fe.element())
            }

            function we(t, n) {
                var i = t.get("minDvrWindow"), o = e.streamType(n, i), r = "LIVE" === o;
            ...
            function xe() {
                var e = new E, t = new c(T, L), n = Ee(), i = new d(T, L);
            ...
            function Ee() {
                ...
                return n.on("click tap", function () {
                    X({type: t.JWPLAYER_DISPLAY_CLICK}), de(1e3), L.play(P())
                }), e.isChrome() && !e.isMobile() && n.el.addEventListener("mousedown", function () {
                    var e = T.getVideo(), t = e && 0 === e.getName().name.indexOf("flash");
                    if (t) {
                        var i = function () {
            ...
            var Ce, Ae, _e, Le, Te, Pe, Re, Me, Ie, Se, Oe, De, Ne, Ye, We, Fe, Je, Be, Ve, Ue, ze, He, Ge = -1, qe = A ? 4e3 : 2e3, Ke = 44, Xe = !1, Qe = -1, $e = -1, Ze = window.requestAnimationFrame || function (e) {
                    return window.setTimeout(e, 17)
                }, et = window.cancelAnimationFrame || window.clearTimeout, tt = -1, nt = !1, it = !1, ot = j.extend(this, i);
            window.webpackJsonpjwplayer && n(115), this.model = T, this.api = L, Ce = e.createElement(y({id: T.get("id")})), e.isIE() && e.addClass(Ce, "jw-ie");
            var rt = T.get("width"), at = T.get("height");
            k(Ce, {
                ...
                var i = T.get("id"), o = T.get("skinColorActive"), r = T.get("skinColorInactive"), a = T.get("skinColorBackground");
    ...
    i = [n(70), n(1), n(26), n(2), n(9), n(7), n(74), n(14), n(75), n(67), n(4), n(5), n(52), n(33), n(50), n(21)], o = function (e, t, n, i, o, r, a, s, l, c, u, d, p, f, h, g) {
        ...
        return w.api = e, w._ = t, w._ = t, w.version = n, w.utils = t.extend(i, o, {
            ...
            tea: l,
            UI: r
        }), w.utils.css.style = w.utils.style, w.vid = c, w.events = t.extend({}, u, {state: d}), w.playlist = t.extend({}, p, {item: f}), w.plugins = g, w
    }.apply(t, i), !(void 0 !== o && (e.exports = o))
}, , , , function (e, t, n) {
    var i, o;
    i = [n(124), n(15), n(183), n(27), n(2), n(1)], o = function (e, t, i, o, r, a) {
        ...
        return e.prototype.setup = function (e, l) {
            ...
            var f = this._model, h = f.get("edition"), g = t(h), w = i.setup();
    ...
    i = [n(74), n(15), n(1), n(2), n(64), n(130), n(27)], o = function (e, t, i, o, r, a, s) {
        ...
        function c(e, n) {
            var o = i.clone(n.get("plugins")) || {}, a = n.get("edition"), s = t(a), c = /^(vast|googima|freewheel)$/, u = /\.(js|swf)$/, d = r.repo(), p = i.clone(n.get("advertising"));
            ...
            var h = n.get("related"), g = i.isObject(h), w = n.get("visualplaylist") !== !1 || g;
            g || (h = {disableRelated: !0}), h.showDockButton = w, l(o, h, "related.js");
        ...
        function p() {
            var e = a.getQueue();
            return e.CHECK_KEY = {method: u, depends: ["LOAD_BASE64_POLYFILL"]}, e.PROBE_DRM_SUPPORT = {
                method: d,
    ...
    i = [], o = function () {
        ...
        function t() {
            ...
            var o = !1, r = !1, a = e();
            return {onReady: t, checkAdBlock: i}
        }
        ...
        return t.extend(n.prototype, e.prototype, {
            buildArray: function () {
                ...
                if (this.model.get("abouttext")) {
                    ...
                    var n = {title: this.model.get("abouttext"), link: this.model.get("aboutlink") || t.items[0].link};
                    t.items.unshift(n)
                }
                return t
            }
